...
def plot2(signal, t, title, signal2, t2, title2 ):
    ...
    ax1.plot(t, signal, color='palevioletred', linewidth=4)
    ...
    ax2.plot(t2, signal2, color='palevioletred', linewidth=4)
...
if seccion == 'Sección 1':
    ...
    st.write('**En esta sección hay 3 grupos de señales disponibles que se pueden convolucionar.**') 
    st.write('**Para conocer cuales son puede acceder a "Ver indice de señales", ubicado en la barra lateral**')
    ...
    if groups2 == 'Grupo 1':
        ...
        signal_moved = st.selectbox('Seleccione la señal que desea desplazar', ('Seleccionar','X1(t)', 'h1(t)') )
            
        if signal_moved == 'h1(t)':
            convolucion_animada(cont2_x1, tx1, cont2_h1, th1, 'x1(t)', 'h1(t-tau)', 4)
                       
        elif signal_moved == 'X1(t)':
            convolucion_animada(cont2_h1, th1,cont2_x1, tx1, 'x1(t)', 'h1(t-tau)', 5)
        ...
        signal_moved = st.selectbox('Seleccione la señal que desea desplazar', ('Seleccionar','X2(t)', 'h2(t)') )

            
        if signal_moved == 'h2(t)':
            
            convol_cont(cont2_x2(tx2),tx2,cont2_h2(th2),th2)
        
        elif signal_moved == 'X2(t)':
            
            convol_cont(cont2_h2(th2),th2, cont2_x2(tx2),tx2)
    
    elif groups2 == 'Grupo 3':
        
        plot2(cont2_h3(th3),th3, 'h_3(t)', cont2_x3(tx3),tx3, 'x_3(t)')
        
        signal_moved = st.selectbox('Seleccione la señal que desea desplazar', ('Seleccionar','X3(t)', 'h3(t)') )
            
        if signal_moved == 'h3(t)':
            
            convol_cont(cont2_x3(tx3),tx3,cont2_h3(th3),th3)
        
        elif signal_moved == 'X3(t)':
            
            convol_cont(cont2_h3(th3),th3, cont2_x3(tx3),tx3)
